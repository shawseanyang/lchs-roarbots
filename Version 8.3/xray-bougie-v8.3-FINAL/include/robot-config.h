...
vex::motor baseBottomLeftMotor (vex::PORT12, vex::gearSetting::ratio6_1);
vex::motor baseBottomRightMotor (vex::PORT1, vex::gearSetting::ratio6_1);

vex::motor leftIntakeMotor (vex::PORT2, vex::gearSetting::ratio6_1);
vex::motor rightIntakeMotor (vex::PORT15, vex::gearSetting::ratio6_1);
...
vex::sonar leftSonar = vex::sonar(Brain.ThreeWirePort.E);
vex::sonar backSonar = vex::sonar(Brain.ThreeWirePort.A);
